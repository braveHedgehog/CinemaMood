...
// Kart genişliğini hesapla (Ekranın yarısı - boşluklar)
const CARD_WIDTH = (width - 60) / 2;

// Tür Listesi (Renk kodları eklendi)
const GENRES = [
...
const styles = StyleSheet.create({
  ...
  card: {
    width: CARD_WIDTH,
    height: CARD_WIDTH * 0.85, // Biraz yatay dikdörtgen
    borderRadius: 24,
    alignItems: 'center',
    justifyContent: 'center',
    borderWidth: 1, // İnce renkli çerçeve
    position: 'relative',
    overflow: 'hidden',
  },
  
  // Dekoratif Renkli Nokta
  dot: {
      position: 'absolute',
      top: 15,
      right: 15,
